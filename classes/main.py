...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_hess_eig", help = "Saves the eigenvalues and the eigenvectors of the Hessian matrix.", action="store_true")
    ...
    globals.save_hess_eig = args.save_hess_eig
